...
public class PageResult<T> implements Serializable {
	...
	private List<Integer> numbers=new ArrayList<Integer>(); //查询的结果

	public PageResult() {
		super();
	}

	public PageResult(int totalCount,int totalPage,int pageIndex, int pageSize, List<T> list, Object bean) {
